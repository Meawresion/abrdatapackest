...
execute if entity @s[tag=bw_3] if score #bw_cdbs bw_calc matches 1 if block ~ ~1 ~ #minecraft:redstone_wall_torch run scoreboard players set #bw_cdbs bw_calc 2
execute if entity @s[tag=bw_4] if score #bw_cdbs bw_calc matches 1 if block ~ ~-1 ~ #minecraft:redstone_wall_torch run scoreboard players set #bw_cdbs bw_calc 2