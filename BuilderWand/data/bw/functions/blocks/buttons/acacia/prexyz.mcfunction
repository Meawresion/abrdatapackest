...
execute if score @s bw_calc matches 1.. run function bw:blocks/buttons/acacia/collidexyz
execute if score #bw_cdbs bw_calc matches 1 run function bw:blocks/buttons/acacia/state
