...
execute if entity @s[tag=bw_3] if block ~ ~1 ~ #bw:boxes run scoreboard players set #bw_cdbs bw_calc 1
execute if entity @s[tag=bw_4] if block ~ ~-1 ~ #bw:boxes run scoreboard players set #bw_cdbs bw_calc 1
