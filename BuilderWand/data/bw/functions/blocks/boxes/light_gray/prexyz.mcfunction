...
execute if score @s bw_calc matches 1.. run function bw:blocks/boxes/light_gray/setone
...
execute if entity @s[tag=bw_spiq] if score #bw_ic bw_calc matches 1.. run function bw:blocks/boxes/light_gray/itemclear