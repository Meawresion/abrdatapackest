...
execute if score @s bw_calc matches 1.. run function bw:blocks/stations/smoker/set
...
execute if score @s bw_mcxyz matches 4 run function bw:blocks/stations/smoker/block_xz
execute if score @s bw_mcxyz matches 5 run function bw:blocks/stations/smoker/block_xy
execute if score @s bw_mcxyz matches 6 run function bw:blocks/stations/smoker/block_zy