...
execute if entity @s[tag=bw_5] unless block ~ ~-1 ~ #bw:gothrough unless block ~ ~-1 ~ minecraft:snow if block ~ ~ ~1 minecraft:snow run scoreboard players set #bw_cdbs bw_calc 1
execute if entity @s[tag=bw_6] unless block ~ ~-1 ~ #bw:gothrough unless block ~ ~-1 ~ minecraft:snow if block ~ ~ ~-1 minecraft:snow run scoreboard players set #bw_cdbs bw_calc 1
