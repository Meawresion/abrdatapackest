#then go through a function-tree to find the selected block matching the score.
execute if score @s bw_block matches ..256 run function bw:blocks/selection/nodes/1-256
execute if score @s bw_block matches 257..336 run function bw:blocks/selection/nodes/257-336
