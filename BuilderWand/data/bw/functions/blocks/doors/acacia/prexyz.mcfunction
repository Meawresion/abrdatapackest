...
execute if score @s bw_calc matches 1.. unless block ~ ~-1 ~ #bw:gothrough if block ~ ~1 ~ #bw:gothrough run function bw:blocks/doors/acacia/state
...
execute if score @s bw_mcxyz matches 4 run function bw:blocks/doors/acacia/block_xz