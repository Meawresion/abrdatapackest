#for looking at negative z side - north side:
tag @s add bw_5
...
execute if score @s bw_calc matches 5..7 run scoreboard players set @s bw_mcxyz 5
execute if score @s bw_calc matches 8 run scoreboard players set @s bw_mcxyz 1
execute if score @s bw_calc matches 9..11 run scoreboard players set @s bw_mcxyz 5
execute if score @s bw_calc matches 12 run scoreboard players set @s bw_mcxyz 1
execute if score @s bw_calc matches 13.. run scoreboard players set @s bw_mcxyz 5

#if the score didn't change from the commands in this function, set the direction score to area mode as a "default"
execute if score @s bw_calc matches 0 run scoreboard players set @s bw_mcxyz 5
