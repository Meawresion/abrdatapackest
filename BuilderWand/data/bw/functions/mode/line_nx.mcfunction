#for looking at negative x side - west side:
tag @s add bw_1
...
#if the score didn't change from the commands in this function, set the direction score to z-direction as a "default"
execute if score @s bw_calc matches 0 run scoreboard players set @s bw_mcxyz 2
