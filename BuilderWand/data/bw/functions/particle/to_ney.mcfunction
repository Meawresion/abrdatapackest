...
execute if score #bw_cds bw_calc matches 1 if score #bw_cdrod bw_calc < #bw_max bw_calc if block ~ ~-1 ~ #bw:gothrough positioned ~ ~-1 ~ run function bw:particle/to_ney