...
execute if entity @s[tag=bw_1] unless block ~1 ~ ~ #bw:gothrough run scoreboard players set #bw_cds bw_calc 1
execute if entity @s[tag=bw_2] unless block ~-1 ~ ~ #bw:gothrough run scoreboard players set #bw_cds bw_calc 1
...
execute if score #bw_cds bw_calc matches 1 if score #bw_cdrod bw_calc < #bw_max bw_calc if block ~ ~ ~-1 #bw:gothrough positioned ~ ~ ~-1 run function bw:particle/to_nez